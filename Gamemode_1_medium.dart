...
class Gamemode_1_medium_Page extends StatefulWidget {
  const Gamemode_1_medium_Page({Key? key}) : super(key: key);

  @override
  State<Gamemode_1_medium_Page> createState() => Gamemode_1_medium_PageState();
}

class Gamemode_1_medium_PageState extends State<Gamemode_1_medium_Page> {
  ...
  var position_x = [-1, -1, -1, -1, -1, -1];
  var position_y = [-1, -1, -1, -1, -1, -1];
            ...
            actions: <Widget>[
              TextButton(
                ...
                onPressed: () {
                  ...
                  updateWinsPatternsMediumNumber();
  ...
  updateWinsPatternsMediumNumber() async
  {
    final SharedPreferences pref = await SharedPreferences.getInstance();

    int oldWinsPatternsMediumNumber = (pref.getInt('keyWinsPatternsMediumNumber') ?? 0);
    int winsPatternsMediumNumber = oldWinsPatternsMediumNumber + 1;
    if (winsPatternsMediumNumber >= 5)
    {
      pref.setBool('keyIconPatternsMedium', true);
    }
    else
    {
      pref.setBool('keyIconPatternsMedium', false);
    }
    pref.setInt('keyWinsPatternsMediumNumber', winsPatternsMediumNumber);
  }
