...
class Gamemode_2_medium_Page extends StatefulWidget {
  const Gamemode_2_medium_Page({Key? key}) : super(key: key);

  @override
  State<Gamemode_2_medium_Page> createState() => Gamemode_2_medium_PageState();
}

class Gamemode_2_medium_PageState extends State<Gamemode_2_medium_Page> {
  ...
  updateWinsNumbersMediumNumber() async
  {
    final SharedPreferences pref = await SharedPreferences.getInstance();

    int oldWinsNumbersMediumNumber = (pref.getInt('keyWinsNumbersMediumNumber') ?? 0);
    int winsNumbersMediumNumber = oldWinsNumbersMediumNumber + 1;
    if (winsNumbersMediumNumber >= 10)
    {
      pref.setBool('keyIconNumbersMedium', true);
    }
    else
    {
      pref.setBool('keyIconNumbersMedium', false);
    }
    pref.setInt('keyWinsNumbersMediumNumber', winsNumbersMediumNumber);
  }
