...
class Gamemode_2_easy_Page extends StatefulWidget {
  const Gamemode_2_easy_Page({Key? key}) : super(key: key);

  @override
  State<Gamemode_2_easy_Page> createState() => Gamemode_2_easy_PageState();
}

class Gamemode_2_easy_PageState extends State<Gamemode_2_easy_Page> {
  ...
  updateWinsNumbersEasyNumber() async
  {
    final SharedPreferences pref = await SharedPreferences.getInstance();

    int oldWinsNumbersEasyNumber = (pref.getInt('keyWinsNumbersEasyNumber') ?? 0);
    int winsNumbersEasyNumber = oldWinsNumbersEasyNumber + 1;
    if (winsNumbersEasyNumber >= 10)
    {
      pref.setBool('keyIconNumbersEasy', true);
    }
    else
    {
      pref.setBool('keyIconNumbersEasy', false);
    }
    pref.setInt('keyWinsNumbersEasyNumber', winsNumbersEasyNumber);
  }
