...
class Gamemode_2_hard_Page extends StatefulWidget {
  const Gamemode_2_hard_Page({Key? key}) : super(key: key);

  @override
  State<Gamemode_2_hard_Page> createState() => Gamemode_2_hard_PageState();
}

class Gamemode_2_hard_PageState extends State<Gamemode_2_hard_Page> {
  ...
  updateWinsNumbersHardNumber() async
  {
    final SharedPreferences pref = await SharedPreferences.getInstance();

    int oldWinsNumbersHardNumber = (pref.getInt('keyWinsNumbersHardNumber') ?? 0);
    int winsNumbersHardNumber = oldWinsNumbersHardNumber + 1;
    if (winsNumbersHardNumber >= 15)
    {
      pref.setBool('keyIconNumbersHard', true);
    }
    else
    {
      pref.setBool('keyIconNumbersHard', false);
    }
    pref.setInt('keyWinsNumbersHardNumber', winsNumbersHardNumber);
  }
