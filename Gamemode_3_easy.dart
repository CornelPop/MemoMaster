...
class Gamemode_3_easy_Page extends StatefulWidget {
  const Gamemode_3_easy_Page({Key? key}) : super(key: key);

  @override
  State<Gamemode_3_easy_Page> createState() => Gamemode_3_easy_PageState();
}

class Gamemode_3_easy_PageState extends State<Gamemode_3_easy_Page> {
  ...
  updateWinsWordsEasyNumber() async
  {
    final SharedPreferences pref = await SharedPreferences.getInstance();

    int oldWinsWordsEasyNumber = (pref.getInt('keyWinsWordsEasyNumber') ?? 0);
    int winsWordsEasyNumber = oldWinsWordsEasyNumber + 1;
    if (winsWordsEasyNumber >= 5)
    {
      pref.setBool('keyIconWordsEasy', true);
    }
    else
    {
      pref.setBool('keyIconWordsEasy', false);
    }
    pref.setInt('keyWinsWordsEasyNumber', winsWordsEasyNumber);
  }
