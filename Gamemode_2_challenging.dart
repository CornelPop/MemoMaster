...
class Gamemode_2_challenging_Page extends StatefulWidget {
  const Gamemode_2_challenging_Page({Key? key}) : super(key: key);

  @override
  State<Gamemode_2_challenging_Page> createState() => Gamemode_2_challenging_PageState();
}

class Gamemode_2_challenging_PageState extends State<Gamemode_2_challenging_Page> {
  ...
  updateWinsNumbersChallengingNumber() async
  {
    final SharedPreferences pref = await SharedPreferences.getInstance();

    int oldWinsNumbersChallengingNumber = (pref.getInt('keyWinsNumbersChallengingNumber') ?? 0);
    int winsNumbersChallengingNumber = oldWinsNumbersChallengingNumber + 1;
    if (winsNumbersChallengingNumber >= 20)
    {
      pref.setBool('keyIconNumbersChallenging', true);
    }
    else
    {
      pref.setBool('keyIconNumbersChallenging', false);
    }
    pref.setInt('keyWinsNumbersChallengingNumber', winsNumbersChallengingNumber);
  }
                              ...
                              return AlertDialog(
                                ...
                                actions: <Widget>[
                                  TextButton(
                                    ...
                                    onPressed: () {
                                      BackgroundMusic.buttonSound();
                                      updateWinsNumbersChallengingNumber();
