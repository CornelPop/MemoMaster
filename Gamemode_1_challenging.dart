...
class Gamemode_1_challenging_Page extends StatefulWidget {
  const Gamemode_1_challenging_Page({Key? key}) : super(key: key);

  @override
  State<Gamemode_1_challenging_Page> createState() => Gamemode_1_challenging_PageState();
}

class Gamemode_1_challenging_PageState extends State<Gamemode_1_challenging_Page> {
  ...
  var position_x = [-1, -1, -1, -1, -1, -1, -1, -1, -1];
  var position_y = [-1, -1, -1, -1, -1, -1, -1, -1, -1];
            ...
            actions: <Widget>[
              TextButton(
                ...
                onPressed: () {
                  ...
                  updateWinsPatternsChallengingNumber();
  ...
  updateWinsPatternsChallengingNumber() async
  {
    final SharedPreferences pref = await SharedPreferences.getInstance();

    int oldWinsPatternsChallengingNumber = (pref.getInt('keyWinsPatternsChallengingNumber') ?? 0);
    int winsPatternsChallengingNumber = oldWinsPatternsChallengingNumber + 1;
    if (winsPatternsChallengingNumber >= 5)
    {
      pref.setBool('keyIconPatternsChallenging', true);
    }
    else
    {
      pref.setBool('keyIconPatternsChallenging', false);
    }
    pref.setInt('keyWinsPatternsChallengingNumber', winsPatternsChallengingNumber);
  }
