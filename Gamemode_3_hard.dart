...
class Gamemode_3_hard_Page extends StatefulWidget {
  const Gamemode_3_hard_Page({Key? key}) : super(key: key);

  @override
  State<Gamemode_3_hard_Page> createState() => Gamemode_3_hard_PageState();
}

class Gamemode_3_hard_PageState extends State<Gamemode_3_hard_Page> {
  ...
  updateWinsWordsHardNumber() async
  {
    final SharedPreferences pref = await SharedPreferences.getInstance();

    int oldWinsWordsHardNumber = (pref.getInt('keyWinsWordsHardNumber') ?? 0);
    int winsWordsHardNumber = oldWinsWordsHardNumber + 1;
    pref.setInt('keyWinsWordsHardNumber', winsWordsHardNumber);
  }
