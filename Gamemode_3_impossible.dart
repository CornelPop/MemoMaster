...
class Gamemode_3_impossible_Page extends StatefulWidget {
  const Gamemode_3_impossible_Page({Key? key}) : super(key: key);

  @override
  State<Gamemode_3_impossible_Page> createState() => Gamemode_3_impossible_PageState();
}

class Gamemode_3_impossible_PageState extends State<Gamemode_3_impossible_Page> {
  ...
  int number6 = Random().nextInt(2500);
  ...
  updateWinsWordsImpossibleNumber() async
  {
    final SharedPreferences pref = await SharedPreferences.getInstance();

    int oldWinsWordsImpossibleNumber = (pref.getInt('keyWinsWordsImpossibleNumber') ?? 0);
    int winsWordsImpossibleNumber = oldWinsWordsImpossibleNumber + 1;
    if (winsWordsImpossibleNumber >= 5)
    {
      pref.setBool('keyIconWordsImpossible', true);
    }
    else
    {
      pref.setBool('keyIconWordsImpossible', false);
    }
    pref.setInt('keyWinsWordsImpossibleNumber', winsWordsImpossibleNumber);
  }
                              ...
                              return AlertDialog(
                                ...
                                actions: <Widget>[
                                  TextButton(
                                    ...
                                    onPressed: () {
                                      BackgroundMusic.buttonSound();
                                      updateWinsWordsImpossibleNumber();
