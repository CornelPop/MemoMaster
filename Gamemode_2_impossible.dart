...
class Gamemode_2_impossible_Page extends StatefulWidget {
  const Gamemode_2_impossible_Page({Key? key}) : super(key: key);

  @override
  State<Gamemode_2_impossible_Page> createState() => Gamemode_2_impossible_PageState();
}

class Gamemode_2_impossible_PageState extends State<Gamemode_2_impossible_Page> {
  ...
  updateWinsNumbersImpossibleNumber() async
  {
    final SharedPreferences pref = await SharedPreferences.getInstance();

    int oldWinsNumbersImpossibleNumber = (pref.getInt('keyWinsNumbersImpossibleNumber') ?? 0);
    int winsNumbersImpossibleNumber = oldWinsNumbersImpossibleNumber + 1;
    if (winsNumbersImpossibleNumber >= 30)
    {
      pref.setBool('keyIconNumbersImpossible', true);
    }
    else
    {
      pref.setBool('keyIconNumbersImpossible', false);
    }
    pref.setInt('keyWinsNumbersImpossibleNumber', winsNumbersImpossibleNumber);
  }
                              ...
                              return AlertDialog(
                                ...
                                actions: <Widget>[
                                  TextButton(
                                    ...
                                    onPressed: () {
                                      BackgroundMusic.buttonSound();
                                      updateWinsNumbersImpossibleNumber();
