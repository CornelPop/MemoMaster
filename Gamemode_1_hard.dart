...
class Gamemode_1_hard_Page extends StatefulWidget {
  const Gamemode_1_hard_Page({Key? key}) : super(key: key);

  @override
  State<Gamemode_1_hard_Page> createState() => Gamemode_1_hard_PageState();
}

class Gamemode_1_hard_PageState extends State<Gamemode_1_hard_Page> {
  ...
  var position_x = [-1, -1, -1, -1, -1, -1, -1, -1];
  var position_y = [-1, -1, -1, -1, -1, -1, -1, -1];
  ...
  updateWinsPatternsHardNumber() async
  {
    final SharedPreferences pref = await SharedPreferences.getInstance();

    int oldWinsPatternsHardNumber = (pref.getInt('keyWinsPatternsHardNumber') ?? 0);
    int winsPatternsHardNumber = oldWinsPatternsHardNumber + 1;
    if (winsPatternsHardNumber >= 5)
    {
      pref.setBool('keyIconPatternsHard', true);
    }
    else
    {
      pref.setBool('keyIconPatternsHard', false);
    }
    pref.setInt('keyWinsPatternsHardNumber', winsPatternsHardNumber);
  }
