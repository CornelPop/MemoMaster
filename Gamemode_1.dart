...
class Gamemode_1_Page extends StatefulWidget {
  const Gamemode_1_Page({Key? key}) : super(key: key);

  @override
  State<Gamemode_1_Page> createState() => Gamemode_1_PageState();
}

class Gamemode_1_PageState extends State<Gamemode_1_Page> {
  ...
  var position_x = [-1, -1, -1];
  var position_y = [-1, -1, -1];
              ...
              actions: <Widget>[
                TextButton(
                  ...
                  onPressed: () {
                    ...
                    updateWinsPatternsBeginnerNumber();
  ...
  updateWinsPatternsBeginnerNumber() async
  {
    final SharedPreferences pref = await SharedPreferences.getInstance();

    int oldWinsPatternsBeginnerNumber = (pref.getInt('keyWinsPatternsBeginnerNumber') ?? 0);
    int winsPatternsBeginnerNumber = oldWinsPatternsBeginnerNumber + 1;
    if (winsPatternsBeginnerNumber >= 5)
    {
      pref.setBool('keyIconPatternsBeginner', true);
    }
    else
    {
      pref.setBool('keyIconPatternsBeginner', false);
    }
    pref.setInt('keyWinsPatternsBeginnerNumber', winsPatternsBeginnerNumber);
  }
